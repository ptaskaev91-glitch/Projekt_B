...
# Persistent owner-authorized HTTPS administration bridge.
# Keep installed until the owner explicitly asks to remove it.
...
[Unit]
Description=Owner-authorized ChatGPT administration bridge
...
[Unit]
Description=Poll owner-authorized administration bridge
